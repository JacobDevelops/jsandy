...
import * as ArrowPrimitive from "@jsandy/ui/arrow";
...
import type { Measurable } from "@jsandy/ui/rect";
...
>((props: ScopedProps<PopperContentProps>, forwardedRef) => {
				...
				size({
					...
					apply: ({ elements, rects, availableWidth, availableHeight }) => {
						...
						contentStyle.setProperty(
							"--jsandy-popper-available-width",
							`${availableWidth}px`,
						);
						contentStyle.setProperty(
							"--jsandy-popper-available-height",
							`${availableHeight}px`,
						);
						contentStyle.setProperty(
							"--jsandy-popper-anchor-width",
							`${anchorWidth}px`,
						);
						contentStyle.setProperty(
							"--jsandy-popper-anchor-height",
							`${anchorHeight}px`,
						);
					},
				}),
	...
	return (
		<div
			...
			data-jsandy-popper-content-wrapper=""
			style={
				{
					...floatingStyles,
					...
					"--jsandy-popper-transform-origin": [
